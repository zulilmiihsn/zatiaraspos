...
<div class="min-h-screen bg-gray-50 flex flex-col page-content">
  ...
  <div class="max-w-lg mx-auto px-4 py-2 md:max-w-3xl md:mx-auto md:py-8">
    <div class="grid grid-cols-2 gap-2 w-full md:grid-cols-3 md:gap-8">
      <a href="/pengaturan/pemilik/manajemenmenu" class="bg-white rounded-lg shadow-sm border border-gray-200 p-3 hover:shadow-md transition-all hover:border-pink-300 group text-left flex flex-col justify-center md:p-8 md:rounded-2xl md:shadow-lg md:gap-3 md:items-center md:justify-center md:h-48 md:text-xl" style="text-decoration:none;">
        <div class="flex items-center gap-2 mb-2 md:gap-2 md:mb-2">
          ...
          <h3 class="text-sm font-semibold text-gray-800 md:text-xl">Manajemen Menu</h3>
        </div>
        <p class="text-xs text-gray-500 leading-tight md:text-xl">Kelola menu, kategori, dan ekstra toko</p>
      </a>
      <a href="/pengaturan/pemilik/gantikeamanan" class="bg-white rounded-lg shadow-sm border border-gray-200 p-3 hover:shadow-md transition-all hover:border-blue-300 group text-left flex flex-col justify-center md:p-8 md:rounded-2xl md:shadow-lg md:gap-3 md:items-center md:justify-center md:h-48 md:text-xl" style="text-decoration:none;">
        <div class="flex items-center gap-2 mb-2 md:gap-2 md:mb-2">
          <svelte:component this={Shield} class="w-5 h-5 text-blue-500 md:w-12 md:h-12" />
          <h3 class="text-sm font-semibold text-gray-800 leading-tight md:text-xl">Ganti Keamanan</h3>
        </div>
        <p class="text-xs text-gray-500 leading-tight md:text-xl">Ubah password dan pengaturan keamanan</p>
      </a>
      <a href="/pengaturan/pemilik/riwayat" class="bg-white rounded-lg shadow-sm border border-gray-200 p-3 hover:shadow-md transition-all hover:border-yellow-300 group text-left flex flex-col justify-center md:p-8 md:rounded-2xl md:shadow-lg md:gap-3 md:items-center md:justify-center md:h-48 md:text-xl" style="text-decoration:none;">
        <div class="flex items-center gap-2 mb-2 md:gap-2 md:mb-2">
          ...
          <h3 class="text-sm font-semibold text-gray-800 leading-tight md:text-xl">Riwayat Transaksi</h3>
        </div>
        <p class="text-xs text-gray-500 leading-tight md:text-xl">Lihat & hapus transaksi hari ini</p>
      </a>
      <div></div>
    </div>
  </div>
