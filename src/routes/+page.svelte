...
} let hideTopbar = false; let topbarRef: HTMLDivElement | null = null; let sentinelRef:
HTMLDivElement | null = null; let selectedBarIndex = null; let showBarInsight = false; let
barHoldTimeout = null;
