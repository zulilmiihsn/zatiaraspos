<script lang="ts">
	...
	function printStrukViaEscPosService() {
		...
		html += `<tr><td style='text-align:left;padding-bottom:4px;'>Total:</td><td style='text-align:right;font-weight:bold;font-size:30px;'>Rp${totalHarga.toLocaleString('id-ID')}</td></tr>`;
