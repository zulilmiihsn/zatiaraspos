...
See D:/Projects/zatiaraspos/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using D:/Projects/zatiaraspos/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using D:/Projects/zatiaraspos/.claude/get-shit-done/templates/discovery.md:
   - Define clear scope
...
6. **Create comprehensive DISCOVERY.md:**
   - Full structure from D:/Projects/zatiaraspos/.claude/get-shit-done/templates/discovery.md
...
Use D:/Projects/zatiaraspos/.claude/get-shit-done/templates/discovery.md.
