...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/Projects/zatiaraspos/.claude
                  → checks D:/Projects/zatiaraspos/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/Projects/zatiaraspos/.claude/get-shit-done
                  → writes to D:/Projects/zatiaraspos/.claude/get-shit-done/hooks/
...
```bash
INIT=$(node "D:/Projects/zatiaraspos/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "D:/Projects/zatiaraspos/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "D:/Projects/zatiaraspos/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
