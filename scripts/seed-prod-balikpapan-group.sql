...
WHERE NOT EXISTS (SELECT 1 FROM profil WHERE cabang_id='balikpapan' AND username='pemilik');
INSERT INTO profil (id,cabang_id,role,username,password,nama_lengkap)
...
INSERT INTO pengaturan (id,cabang_id,halaman_terkunci,nama_toko)
SELECT 910003,'balikpapan','["laporan","beranda","pengaturan","catat"]','Zatiaras Balikpapan'
...
WHERE NOT EXISTS (SELECT 1 FROM profil WHERE cabang_id='balikpapan2' AND username='pemilik');
INSERT INTO profil (id,cabang_id,role,username,password,nama_lengkap)
...
INSERT INTO pengaturan (id,cabang_id,halaman_terkunci,nama_toko)
SELECT 910004,'balikpapan2','["laporan","beranda","pengaturan","catat"]','Zatiaras Balikpapan2'
